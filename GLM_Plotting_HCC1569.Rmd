...
# Select which treatment that I want to plot
inputPanel(
...
# Store a reactive object of EdU data for Shiny 
datadfEdU <- reactive({
  result <- glm.other.means
  return(result)
  })

# Store a reactive object of pHER2/HER2 data for Shiny 
datadfHER2 <- reactive({
  result <- glm.other.means.HER2
  return(result)
})

# Store a reactive object of selected treatment
condition <- reactive({
