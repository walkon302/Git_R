...
load('/Users/Walkon302/Desktop/PC3_data/GLM_means_PC3.RData')
load('/Users/Walkon302/Desktop/PC3_data/GLM_HER2means_PC3.RData')
load('/Users/Walkon302/Desktop/PC3_data/PC3_pca.RData')
glm.other.means <- glmmean
glm.other.means.HER2 <- glmHER2mean
...
edu_min <- min(glm.other.means$`EdU_%_Total_Cells`)
edu_max <- max(glm.other.means$`EdU_%_Total_Cells`)
her2_min <- min(pHER2_HER2_Status$`pHER2/HER2_Status`)
her2_max <- max(pHER2_HER2_Status$`pHER2/HER2_Status`)
```
